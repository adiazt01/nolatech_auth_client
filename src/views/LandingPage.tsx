...
export function LandingPage() {
  return (
    <>
      ...
      <ProductSection />
      <ServiceSection />
      <section className="relative px-4 pt-8 flex flex-col lg:flex-row min-h-screen gap-8 justify-center items-end bg-green-600">
        <div className="flex gap-16 mb-auto lg:mt-20 max-w-lg flex-col px-4">
          <h2 className="text-3xl text-white md:text-5xl lg:text-7xl font-bold">
